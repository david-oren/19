# Generated by Powerlevel10k configuration wizard on 2020-07-16 at 01:11 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 9179.
# Wizard options: ascii, lean_8colors, 24h time, 2 lines, disconnected, compact, fluent.
